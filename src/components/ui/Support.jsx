...
function Support() {
  return (
    <div className="py-10 lg:py-[120px]" id="support">
        <div className="container">
            <div className="flex items-start font-stk flex-col lg:flex-row gap-4 lg:gap-0 font-stk-book">
                ...
                <div className="flex lg:gap-1 flex-[80%] flex-col lg:flex-row gap-4">
                    <div className="flex flex-1 items-stretch p-6 bg-[#1C1C1C] min-h-[442px]">
                        <div className="flex flex-col items-stretch justify-between">
                            <h5 className="text-white text-3xl tracking-[-.01em] leading-8">Sales</h5>
                            <p className="text-sm leading-4 tracking-[-0.01em] text-white">Your ideas, questions, or plans— <br /> our sales team is listening.</p>
                    ...
                    <div className="flex flex-1 items-stretch p-6 bg-[#F7F6F5] min-h-[442px]">
                        <div className="flex flex-col items-stretch justify-between">
                            <h5 className="text-[#292929] text-3xl tracking-[-.01em] leading-8">General Enquiry</h5>
                            <p className="text-sm leading-4 tracking-[-0.01em] text-[#292929]">For any other questions, reach out via email—<br /> say hello, we're (really) super friendly.</p>
                    ...
                    <div className="flex flex-1 items-stretch p-6 bg-[#F7F6F5] min-h-[442px]">
                        <div className="flex flex-col items-stretch justify-between">
                            <h5 className="text-[#292929] text-3xl tracking-[-.01em] leading-8">Support</h5>
                            <p className="text-sm leading-4 tracking-[-0.01em] text-[#292929]">If you’ve lost email access or anything else,<br /> message us here. We’re available 16 hours daily.</p>
