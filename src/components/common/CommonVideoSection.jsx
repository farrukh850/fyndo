...
function CommonVideoSection({ packageName, deliveryTime, videoMainHeading, videoSubHeading, VideoPara, VideoDeliveryTime, VideoCost, bgColor, videoRightColor, videoSrc }) {
  return (
    <div className={`justify-between relative pb-4 lg:pb-0`} style={{ backgroundColor: bgColor }}>
        <div className="container flex items-stretch flex-col lg:flex-row min-h-[400px] lg:min-h-[740px]">
